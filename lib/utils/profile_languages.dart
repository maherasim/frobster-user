/// Static language options matching backend profile_form.blade.php (value => label).
/// Used for multi-select "Known languages" on edit profile.
const Map<String, String> profileLanguageOptions = {
  'afrikaans': 'Afrikaans',
  'albanian': 'Albanian',
  'amharic': 'Amharic',
  'arabic': 'Arabic',
