class CommonKeys {
  ...
  static String scheduleSlots = 'schedule_slots';
}
...
class BookingStatusKeys {
  ...
  static String doneByProvider = 'done_by_provider';
...
class PostJob {
  ...
  static String serviceId = 'service_id';
  static String price = 'price';
  static String priceType = 'type';
  static String category_id = 'category_id';
  static String subcategory_id = 'subcategory_id';
  static String country = 'country_id';
  static String city = 'city_id';
  static String startDate = 'start_date';
  static String endDate = 'end_date';
  static String totalDays = 'total_days';
  static String totalHours = 'total_hours';
  static String requirements = 'requirement';
