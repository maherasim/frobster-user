  ...
  factory BookingDetailResponse.fromJson(Map<String, dynamic> json) {
    return BookingDetailResponse(
      ...
      handymanData: json['handyman_data'] != null
          ? (json['handyman_data'] as List).map((e) {
              if (e is Map<String, dynamic>) {
                // New pattern: { "handyman": {..user..}, "handyman_review": {..} }
                final dynamic inner = e['handyman'];
                if (inner is Map<String, dynamic>) {
                  final user = UserData.fromJson(inner);
                  final review = e['handyman_review'];
                  if (review is Map<String, dynamic>) {
                    user.handymanReview = HandymanReview.fromJson(review);
                  }
                  return user;
                }
              ...
              // As a last resort, try toString->json not supported; return empty user
              return UserData();
            }).toList()
          : null,
