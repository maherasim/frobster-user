...
class BookingData {
  ...
  String? date;
  String? durationDiff;
  // Location fields returned by booking-list API
  String? cityName;
  String? countryName;
  int? paymentId;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['start_date'] = this.startAt;
    data['end_date'] = this.endAt;
    data['booking_type'] = this.bookingType;
    if (this.visitType != null) data['visit_type'] = this.visitType;
    ...
    if (this.timeSlots != null) {
      data['service_slots'] = this.timeSlots!.map((e) => e.toJson()).toList();
    }
