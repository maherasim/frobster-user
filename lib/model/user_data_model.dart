...
class UserData {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.mobility != null) data['mobility'] = this.mobility;
    if (this.availability != null) data['availability'] = this.availability;
    if (this.education != null) data['education'] = this.education;
    if (this.certification != null) data['certification'] = this.certification;
