...
class CustomImagePicker extends StatefulWidget {
  ...
  CustomImagePicker({
    ...
    this.textSize,
    this.imageSize,
    this.isMultipleImages = false,  this.canEdit = true,
  }) : super(key: key);
    ...
    return Column(
      ...
      children: [
        if(widget.canEdit) ...[
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    8.height,
                    Text(language.chooseImage, style: secondaryTextStyle()),
                  ],
                ),
              ),
            ),
          ...
          16.height,
          Text(
            widget.isMultipleImages ? language.selectImgNote : language.noteYouCanUpload,
