...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void savePay({
    ...
    print(widget.bookings.bookingDetail!.paymentStatus == null);
    print( widget.bookings.bookingDetail!.paymentStatus != SERVICE_PAYMENT_STATUS_ADVANCE_PAID );
    print(widget.bookings.bookingDetail!.paymentStatus != SERVICE_PAYMENT_STATUS_PAID);
    print(widget.bookings.bookingDetail!.paidAmount == null);
    print(widget.bookings.bookingDetail!.paidAmount.validate() <= 0);
    // appStore.setLoading(false);
    // print(request);
    // return;
