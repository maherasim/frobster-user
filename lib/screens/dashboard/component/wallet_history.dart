                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Builder(builder: (context) {
                              final num creditDebit = data
                                  .activityData!.creditDebitAmount
                                  .validate();
                              final num amount =
                                  data.activityData!.amount.validate();
                              final num amountToShow =
                                  (creditDebit != 0) ? creditDebit : amount;
                              return Text(
                                amountToShow.toPriceFormat(),
                                style: boldTextStyle(
                                    color: data.activityData!.transactionType
                                            .isEmptyOrNull
                                        ? Colors.red
