...
class FilterSubCategoryComponent extends StatefulWidget {
  final List<CategoryData> catList;

  FilterSubCategoryComponent({required this.catList});

  @override
  State<FilterSubCategoryComponent> createState() =>
      _FilterSubCategoryComponentState();
}

class _FilterSubCategoryComponentState
    extends State<FilterSubCategoryComponent> {
  int? isSelected;
