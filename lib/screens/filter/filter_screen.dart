              ...
              child: Row(
                children: [
                  if (filterStore.providerId.validate().isNotEmpty ||
                      ...
                      filterStore.countryId.validate().isNotEmpty ||
                  ...
                  AppButton(
                    ...
                    onTap: () {
                      ...
                      countryList.forEach((element) {
                        if (element.isSelected) {
                          filterStore.addToCountryList(
                              ctryId: element.id.validate());
                        }
                      });
                      ...
                      cityList.forEach((element) {
                        if (element.isSelected) {
                          filterStore.addToCityList(id: element.id.validate());
                        }
                      });
