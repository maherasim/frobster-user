                              ...
                              Row(
                                children: [
                                  Text(language.lblTax,
                                      style: secondaryTextStyle(size: 14)),
                                  Text(
                                    " (${(bookingDetail.finalTotalTax.validate() / bookingDetail.finalSubTotal.validate() * 100).toInt()}%)",
                                    style: boldTextStyle(
                                        color: primaryColor, size: 14),
                                  ).expand()
                                ],
                              ).expand(),
                              if (bookingDetail.taxes.validate().isNotEmpty)
                                Icon(Icons.info_outline_rounded,
                                        size: 20, color: context.primaryColor)
                                    .onTap(
                                  () {
