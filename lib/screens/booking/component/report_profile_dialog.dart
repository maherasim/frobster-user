...
/// Report a user profile (POST /ugc/report-profile); reasons from GET /ugc/report-reasons.
class ReportProfileDialog extends StatefulWidget {
  final int reportedUserId;

  const ReportProfileDialog({super.key, required this.reportedUserId});
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        language.ugcReportProfileTitle,
