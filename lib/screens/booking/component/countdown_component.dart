...
class _CountdownWidgetState extends State<CountdownWidget> {
  ...
  void initState() {
    if (widget.bookingDetailResponse.bookingDetail!.status.validate() ==
      ...
      // log('startAt: ${widget.bookingDetailResponse.bookingDetail!.startAt}');
      // value =
      //     "${(widget.bookingDetailResponse.bookingDetail!.durationDiff.toInt() + DateTime.now().difference(widget.bookingDetailResponse.bookingDetail!.timeSlots!.first.selectedDate).inSeconds)}"
      // .toInt();
      stopTimer = false;
      init();
    } else {
