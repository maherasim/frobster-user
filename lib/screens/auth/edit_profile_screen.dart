                ...
                DropdownButtonFormField<CareerLevel>(
                  ...
                  items: CareerLevel.values.map((CareerLevel e) {
                    return DropdownMenuItem<CareerLevel>(
                      ...
                      child: Text(
                        switch (e) {
                          CareerLevel.notSpecified => language.careerNotSpecified,
                          CareerLevel.entryLevel => language.careerEntryLevel,
                          CareerLevel.intermediateLevel => language.careerIntermediateLevel,
                          CareerLevel.experienced => language.careerExperienced,
                          CareerLevel.professional => language.careerProfessional,
                          CareerLevel.middleManagement => language.careerMiddleManagement,
                          CareerLevel.executiveManagement => language.careerExecutiveManagement,
                          CareerLevel.seniorManagement => language.careerSeniorManagement,
                          CareerLevel.director => language.careerDirector,
                          CareerLevel.technician => language.careerTechnician,
                          CareerLevel.leader => language.careerLeader,
                          CareerLevel.manager => language.careerManager,
                        },
                        style: primaryTextStyle(),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                ...
                DropdownButtonFormField<EducationLevel>(
                  ...
                  items: EducationLevel.values.map((EducationLevel e) {
                    return DropdownMenuItem<EducationLevel>(
                      ...
                      child: Text(
                        switch (e) {
                          EducationLevel.notSpecified => language.eduNotSpecified,
                          EducationLevel.anyGraduate => language.eduAnyGraduate,
                          EducationLevel.apprenticeshipDegree => language.eduApprenticeshipDegree,
                          EducationLevel.traineeshipDegree => language.eduTraineeshipDegree,
                          EducationLevel.secondaryDegree => language.eduSecondaryDegree,
                          EducationLevel.undergraduateDiploma => language.eduUndergraduateDiploma,
                          EducationLevel.highSchoolGraduate => language.eduHighSchoolGraduate,
                          EducationLevel.associateDegree => language.eduAssociateDegree,
                          EducationLevel.collegeDegree => language.eduCollegeDegree,
                          EducationLevel.universityDegree => language.eduUniversityDegree,
                          EducationLevel.bachelorsDegree => language.eduBachelorsDegree,
